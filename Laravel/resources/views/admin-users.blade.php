    ...
    <div class="w-64 bg-gray-800 flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto py-4">
            <nav class="space-y-1 px-3">
                ...
                <a href="/admin/users" class="bg-gray-900 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <main class="flex-1 p-6 bg-gray-100">
            <div class="bg-white shadow rounded-lg p-6">
                <h3 class="text-lg font-medium text-gray-900 border-b pb-4">User List</h3>
                <p class="mt-4 text-sm text-gray-500">This is the User Management page. It works!</p>
            </div>
        </main>
    </div>
</div>
